      ...
      <div className="relative">
        ...
        {canTogglePassword && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-text-muted hover:text-text-primary transition-colors p-1 rounded focus:outline-none focus:text-circuit cursor-pointer"
